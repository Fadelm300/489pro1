...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 15, 2023 at 12:53 PM
...
CREATE TABLE `admin` (
  ...
  `administration level` varchar(30) NOT NULL,
...
--
ALTER TABLE `prescriptions`
  ADD CONSTRAINT `prescriptions_ibfk_1` FOREIGN KEY (`Employee ID`) REFERENCES `pharmacist` (`Employee ID`),
...
--
ALTER TABLE `report`
  ADD CONSTRAINT `report_ibfk_1` FOREIGN KEY (`employee ID`) REFERENCES `admin` (`Employee ID`);
