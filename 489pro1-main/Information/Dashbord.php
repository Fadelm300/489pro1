...
<div class="container">
    ...
    <div class="headercards"> 
          <div class="p1up">
                    ...
                    <div class="card2"><p>Dashbord</p> </div>
            </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="viewmedicine.php">
                                ...
                                <span class="item">Admin Medecine</span>
                            </a>
                        </li>
                        <li>
 ...
 <!--end of the sidebar--> <!--start of the sidebar-->
...
try {
    ...
    echo "<br><br><div class='results'>Number of Medicine   : ".$count."</div>";
    
    $db = null;
} catch (PDOException $x) {
    die($x->getMessage());
}
//in the next class we can any data we need chart or any table 
