...
<div class="container">
    ...
    <div class="headercards"> 
          <div class="p1up">
                    ...
                    <div class="card2"><p>view Patientr</p> </div>
            </div>
...
while ($row = $r->fetch()) {
    echo "<table border=1 '>";
    echo "<tr>";
    echo "<th> <h4>patient ID:</h4> <h5> $row[0] </h5></th>";
    echo "<th> <h4>First Name:</h4> <h5> $row[2] </h5></th>";
    echo "<th> <h4> Last Name:</h4><h5> $row[3] </h5></th>";
    echo "<th> <h4> dateOfBirth:</h4> <h5> $row[4] </h5> </th>";
    echo "<th> <h4> gender :</h4> <h5> $row[5] </h5> </th>";

    echo "<th> <h4> Email:</h4> <h5> $row[6] </h5> </th>";
    echo "<th>  <h4>PhoneNO:</h4><h6>( $row[7])$row[8] </h6> </th>";
    echo "<th>  <h4> 	address</br> nu flat_house/road/BLD/governorate	:</h4><h6> $row[9]/$row[10]/$row[11]/$row[12] </h6>  </th>";
