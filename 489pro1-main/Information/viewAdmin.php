...
<div class="container">
    ...
    <div class="headercards"> 
          <div class="p1up">
                    ...
                    <div class="card2"><p>view Admin</p> </div>
            </div>
...
while ($row = $r->fetch()) {
    ...
    echo "<th> <h4>Pharmacist administration level:</h4> <h5> $row[1] </h5></th>";
...
<table border=1>
    <tr >
        ...
        <th>address</th>
                        ...
                        <td>
              <a href="delete3.php?ADEEL=<?php echo $row['Employee_ID']?>" class="link-dark"><i class="fa-solid fa-trash
              fs-5 me-3"></i></a>
                        </td>
